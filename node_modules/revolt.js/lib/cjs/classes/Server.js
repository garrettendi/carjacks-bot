...
class Server {
    ...
    get iconURL() {
        var _a;
        return (_a = this.icon) === null || _a === void 0 ? void 0 : _a.createFileURL();
    }
    /**
    ...
    get animatedIconURL() {
        var _a;
        return (_a = this.icon) === null || _a === void 0 ? void 0 : _a.createFileURL(true);
    }
    /**
    ...
    get bannerURL() {
        var _a;
        return (_a = this.banner) === null || _a === void 0 ? void 0 : _a.createFileURL();
    }
    /**
