...
class User {
    ...
    get avatarURL() {
        var _a, _b;
        return (_b = (_a = this.avatar) === null || _a === void 0 ? void 0 : _a.createFileURL()) !== null && _b !== void 0 ? _b : this.defaultAvatarURL;
    }
    /**
    ...
    get animatedAvatarURL() {
        var _a, _b;
        return (_b = (_a = this.avatar) === null || _a === void 0 ? void 0 : _a.createFileURL(true)) !== null && _b !== void 0 ? _b : this.defaultAvatarURL;
    }
    /**
     * Presence
     */
