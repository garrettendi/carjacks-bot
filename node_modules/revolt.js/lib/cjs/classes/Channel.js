...
class Channel {
    ...
    get iconURL() {
        var _a, _b, _c;
        return (_b = (_a = this.icon) === null || _a === void 0 ? void 0 : _a.createFileURL()) !== null && _b !== void 0 ? _b : (_c = this.recipient) === null || _c === void 0 ? void 0 : _c.avatarURL;
    }
    /**
    ...
    get animatedIconURL() {
        var _a, _b, _c;
        return (_b = (_a = this.icon) === null || _a === void 0 ? void 0 : _a.createFileURL(true)) !== null && _b !== void 0 ? _b : (_c = this.recipient) === null || _c === void 0 ? void 0 : _c.animatedAvatarURL;
    }
    /**
    ...
    edit(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield __classPrivateFieldGet(this, _Channel_collection, "f").client.api.patch(`/channels/${this.id}`, data);
            __classPrivateFieldGet(this, _Channel_collection, "f").updateUnderlyingObject(this.id, (0, index_js_1.hydrate)("channel", channel, __classPrivateFieldGet(this, _Channel_collection, "f").client, false));
        });
    }
    /**
