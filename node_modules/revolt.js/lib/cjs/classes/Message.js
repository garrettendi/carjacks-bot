...
class MessageWebhook {
    ...
    get avatarURL() {
        var _a, _b;
        return ((_b = (_a = this.avatar) === null || _a === void 0 ? void 0 : _a.createFileURL()) !== null && _b !== void 0 ? _b : `${__classPrivateFieldGet(this, _MessageWebhook_client, "f").options.baseURL}/users/${this.id}/default_avatar`);
    }
}
