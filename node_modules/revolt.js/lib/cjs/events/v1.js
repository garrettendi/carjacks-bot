    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (event.type) {
            ...
            case "MessageUpdate": {
                ...
                if (message) {
                    const previousMessage = Object.assign(Object.assign({}, client.messages.getUnderlyingObject(event.id)), { channelId: event.channel });
                    client.messages.updateUnderlyingObject(event.id, Object.assign(Object.assign({}, (0, index_js_1.hydrate)("message", Object.assign(Object.assign({}, event.data), { channel: event.channel }), client, false)), { editedAt: new Date() }));
            ...
            case "MessageAppend": {
                ...
                if (message) {
                    ...
                    client.messages.updateUnderlyingObject(event.id, "embeds", (embeds) => {
                        var _a, _b;
                        return [
                            ...(embeds !== null && embeds !== void 0 ? embeds : []),
                            ...((_b = (_a = event.append.embeds) === null || _a === void 0 ? void 0 : _a.map((embed) => index_js_2.MessageEmbed.from(client, embed))) !== null && _b !== void 0 ? _b : []),
                        ];
                    });
            ...
            case "ChannelUpdate": {
                ...
                if (channel) {
                    ...
                    const changes = (0, index_js_1.hydrate)("channel", event.data, client, false);
                    if (event.clear) {
            ...
            case "ServerUpdate": {
                ...
                if (server) {
                    ...
                    const changes = (0, index_js_1.hydrate)("server", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Banner":
            ...
            case "ServerRoleUpdate": {
                const server = client.servers.getOrPartial(event.id);
                if (server) {
                    const role = (_a = server.roles.get(event.role_id)) !== null && _a !== void 0 ? _a : {};
            ...
            case "ServerMemberUpdate": {
                ...
                if (member) {
                    ...
                    const changes = (0, index_js_1.hydrate)("serverMember", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Nickname":
            ...
            case "UserUpdate": {
                ...
                if (user) {
                    ...
                    const changes = (0, index_js_1.hydrate)("user", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Avatar":
                                    ...
                                    break;
                                case "StatusPresence":
                                    changes["status"] = Object.assign(Object.assign(Object.assign({}, ((_b = previousUser.status) !== null && _b !== void 0 ? _b : {})), ((_c = changes["status"]) !== null && _c !== void 0 ? _c : {})), { presence: undefined });
                                    break;
                                case "StatusText":
                                    changes["status"] = Object.assign(Object.assign(Object.assign({}, ((_d = previousUser.status) !== null && _d !== void 0 ? _d : {})), ((_e = changes["status"]) !== null && _e !== void 0 ? _e : {})), { text: undefined });
                                    break;
                            }
                        }
                    }
