...
var _EventClient_protocolVersion, _EventClient_transportFormat, _EventClient_setPing, _EventClient_setStateSetter, _EventClient_socket, _EventClient_heartbeatIntervalReference, _EventClient_pongTimeoutReference, _EventClient_connectTimeoutReference, _EventClient_lastError;
...
class EventClient extends eventemitter3_1.default {
    ...
    constructor(protocolVersion, transportFormat = "json", options) {
        ...
        _EventClient_connectTimeoutReference.set(this, void 0);
        _EventClient_lastError.set(this, void 0);
        ...
        this.options = Object.assign({ heartbeatInterval: 30, pongTimeout: 10, connectTimeout: 10, debug: false }, options);
    ...
    connect(uri, token) {
        this.disconnect();
        __classPrivateFieldSet(this, _EventClient_lastError, undefined, "f");
        this.setState(ConnectionState.Connecting);
        __classPrivateFieldSet(this, _EventClient_connectTimeoutReference, setTimeout(() => this.disconnect(), this.options.pongTimeout * 1e3), "f");
        ...
        __classPrivateFieldGet(this, _EventClient_socket, "f").onerror = (error) => {
            __classPrivateFieldSet(this, _EventClient_lastError, { type: "socket", data: error }, "f");
            this.emit("error", error);
        };
        __classPrivateFieldGet(this, _EventClient_socket, "f").onmessage = (event) => {
            clearInterval(__classPrivateFieldGet(this, _EventClient_connectTimeoutReference, "f"));
    ...
    disconnect() {
        ...
        clearInterval(__classPrivateFieldGet(this, _EventClient_connectTimeoutReference, "f"));
        clearInterval(__classPrivateFieldGet(this, _EventClient_pongTimeoutReference, "f"));
    ...
    handle(event) {
        ...
        switch (event.type) {
            ...
            case "Pong":
                ...
                return;
            case "Error":
                __classPrivateFieldSet(this, _EventClient_lastError, {
                    type: "revolt",
                    data: event.data,
                }, "f");
     ...
     */
    get lastError() {
        return __classPrivateFieldGet(this, _EventClient_lastError, "f");
    }
}
exports.EventClient = EventClient;
_EventClient_protocolVersion = new WeakMap(), _EventClient_transportFormat = new WeakMap(), _EventClient_setPing = new WeakMap(), _EventClient_setStateSetter = new WeakMap(), _EventClient_socket = new WeakMap(), _EventClient_heartbeatIntervalReference = new WeakMap(), _EventClient_pongTimeoutReference = new WeakMap(), _EventClient_connectTimeoutReference = new WeakMap(), _EventClient_lastError = new WeakMap();
