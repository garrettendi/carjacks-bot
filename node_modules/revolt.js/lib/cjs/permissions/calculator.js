...
function calculatePermission(client, target, options) {
    ...
    if (user === null || user === void 0 ? void 0 : user.privileged) {
        return definitions_js_1.Permission.GrantAllSafe;
    }
    if (target instanceof index_js_1.Server) {
        // 1. Check if owner.
        if (target.ownerId === (user === null || user === void 0 ? void 0 : user.id)) {
            ...
            if (member.timeout && member.timeout > new Date()) {
                perm = perm.and(definitions_js_1.ALLOW_IN_TIMEOUT);
            }
        ...
        switch (target.type) {
            ...
            case "DirectMessage": {
                ...
                if (user_permissions & definitions_js_1.UserPermission.SendMessage) {
                    return definitions_js_1.DEFAULT_PERMISSION_DIRECT_MESSAGE;
                }
                else {
                    return definitions_js_1.DEFAULT_PERMISSION_VIEW_ONLY;
                }
            }
            case "Group": {
                ...
                if (target.ownerId === user.id) {
                    ...
                    return (_d = target.permissions) !== null && _d !== void 0 ? _d : definitions_js_1.DEFAULT_PERMISSION_DIRECT_MESSAGE;
                }
            }
            case "TextChannel":
            case "VoiceChannel": {
