...
exports.channelHydration = void 0;
const set_1 = require("@solid-primitives/set");
const index_js_1 = require("../index.js");
exports.channelHydration = {
    keyMapping: {
        _id: "id",
    ...
    functions: {
        ...
        icon: (channel, ctx) => new index_js_1.File(ctx, channel.icon),
        active: (channel) => channel.active || false,
        typingIds: () => new set_1.ReactiveSet(),
        recipientIds: (channel) => new set_1.ReactiveSet(channel.recipients),
    ...
    initialHydration: () => ({
        typingIds: new set_1.ReactiveSet(),
        recipientIds: new set_1.ReactiveSet(),
    }),
};
