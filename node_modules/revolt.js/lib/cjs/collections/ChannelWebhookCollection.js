...
const ChannelWebhook_js_1 = require("../classes/ChannelWebhook.js");
const index_js_1 = require("./index.js");
/**
 * Collection of Channel Webhooks
 */
class ChannelWebhookCollection extends index_js_1.ClassCollection {
    /**
     * Fetch webhook by ID
     * @param id Id
     * @returns Webhook
    ...
    getOrCreate(id, data) {
        if (this.has(id)) {
            ...
            const instance = new ChannelWebhook_js_1.ChannelWebhook(this, id);
