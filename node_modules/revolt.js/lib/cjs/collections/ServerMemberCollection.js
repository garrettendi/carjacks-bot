 ...
 */
class ServerMemberCollection extends index_js_2.ClassCollection {
    /**
    ...
    fetch(serverId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (member && !this.isPartial(serverId + userId))
                return member;
            const data = (yield this.client.api.get(`/servers/${serverId}/members/${userId}`, {
                roles: false,
            }
    ...
    getOrCreate(id, data) {
        if (this.hasByKey(id) && !this.isPartialByKey(id)) {
            ...
            const instance = new index_js_1.ServerMember(this, id);
