...
const MFA_js_1 = require("../classes/MFA.js");
/**
...
class AccountCollection {
    ...
    mfa() {
        return __awaiter(this, void 0, void 0, function* () {
            const state = yield this.client.api.get("/auth/mfa/");
            return new MFA_js_1.MFA(this.client, state);
        });
    }
    /**
    ...
    setSettings(settings, timestamp = +new Date()) {
        return this.client.api.post("/sync/settings/set", Object.assign(Object.assign({}, settings), { timestamp }));
    }
