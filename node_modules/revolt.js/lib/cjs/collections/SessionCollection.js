 ...
 */
class SessionCollection extends index_js_2.ClassCollection {
    /**
     ...
     */
    deleteAll() {
        return __awaiter(this, arguments, void 0, function* (revokeSelf = false) {
    ...
    getOrCreate(id, data) {
        if (this.has(id)) {
            ...
            const instance = new index_js_1.Session(this, id);
