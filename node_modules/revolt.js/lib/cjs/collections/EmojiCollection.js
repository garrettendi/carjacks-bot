 ...
 * Collection of Emoji
 */
class EmojiCollection extends index_js_2.ClassCollection {
    /**
     * Fetch emoji by ID
     * @param id Id
     * @returns Emoji
    ...
    fetch(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (emoji && !this.isPartial(id))
                return emoji;
            const data = yield this.client.api.get(`/custom/emoji/${id}`);
    ...
    getOrCreate(id, data, isNew = false) {
        if (this.has(id) && !this.isPartial(id)) {
            ...
            const instance = new index_js_1.Emoji(this, id);
