 ...
 */
class ChannelCollection extends index_js_2.ClassCollection {
    /**
     * Delete an object
     * @param id Id
     */
    ...
    getOrCreate(id, data, isNew = false) {
        if (this.has(id) && !this.isPartial(id)) {
            ...
            const instance = new index_js_1.Channel(this, id);
    ...
    createGroup(name, users) {
        return __awaiter(this, void 0, void 0, function* () {
            const group = yield this.client.api.post(`/channels/create`, {
                name,
                users: users.map((user) => (user instanceof index_js_1.User ? user.id : user)),
            });
